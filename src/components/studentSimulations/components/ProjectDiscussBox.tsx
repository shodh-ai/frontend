...
export default function ProjectDiscussBox() {
  ...
  return (
    <div className="border  flex flex-col min-h-[664px] w-full max-w-[650px] max-lg:max-w-full gap-4 border-[var(--Border-Secondary)] rounded-xl p-5 bg-black text-white">
